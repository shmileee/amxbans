<div class="main">
	...
	<span>
		{if isset($check_id)}
			<span style='color:white;font-weight:bold;text-shadow: #990000 0px 0px 3px;'><a href="http://{$smarty.server.HTTP_HOST}{$smarty.server.PHP_SELF}?bid={$check_id}">{"_YOUAREBANNED"|lang}</a></span></div>
		{else}
