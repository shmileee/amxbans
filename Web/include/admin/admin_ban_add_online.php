...
if (!function_exists('geoip_country_code_by_addr')) {
	...
	if(!$servers_array[$sid]["address"]) $sid=0;
		...
		if($pl_silent) {
			...
			if(!$user_msg) {
				...
				$query = mysql_query("INSERT INTO `".$config->db_prefix."_bans` 
						...
						VALUES 
						('".$pl_ip."','".$pl_steamid."','".$pl_name."','".$_SESSION["uname"]."','".$_SESSION["uname"]."','".$type."','".$pl_reason."','".$pl_reason."',UNIX_TIMESTAMP(),'".$pl_ban_length."','website')
						") or die (mysql_error());
