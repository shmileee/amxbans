...
define("_STEP2","Informatsioon");
define("_STEP3","Asukohad");
define("_STEP4","Andmebaas");
define("_STEP5","Administratsioon");
...
define("_PREFIXEXISTSV5","Olemasolev installeerimine on leitud, ei ole midagi uuendada!");
define("_PREFIXEXISTSV6","Olemasolev installeerimine on leitud, see on nüüd uuendatud!");
...
define("_EMAILADR","E-mail aadress");
...
define("_TABLECREATE","Tabelite struktuuri tegemine");
define("_DEFAULTDATACREATE","Nõutud andmete sisestamine");
define("_DEFAULTWEBSETTINGSCREATE","Sisesta seaded");
define("_DEFAULTUSERMENUCREATE","Sea kasutajamenüü");
define("_DEFAULTMODULESCREATE","Installi moodul");
define("_WEBADMINCREATE","Lisa Web-Admin");
define("_ALREADYEXISTS","Juba eksisteerib");
define("_CREATED","Edukalt lisatud");
...
define("_SETUPEND","Mine AMXBans-i...");
?>